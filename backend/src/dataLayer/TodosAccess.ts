...
export class TodosAccess {
    ...
    async updateAttachmentUrl(todoId: string, attachmentUrl: string, thumbnailUrl: string) {
        ...
        await this.docClient.update({
            ...
            UpdateExpression: 'set attachmentUrl = :attachmentUrl,thumbnailUrl = :thumbnailUrl',
            ExpressionAttributeValues: {
